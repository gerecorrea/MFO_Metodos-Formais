...
(*LISTA INDUCTION GEREMIAS CORRÊA:
  Nessa lista, são o que está reazalido originalmente em soma com o que fiz para os exercícios de Induction
  Fica o porém que por algum motivo misterioso não conseugui puxar o arquivo Basics.v
  Por conta disso, puxo manualmente.
  Além disso, testo elas em separado, exercício por exercício em um arquivo solo, nomeado de forma padrão
  Indicado analisar por lá, após lá funcionar eu passo ele para cá então.
*)
...
(*From LF Require Export Basics_AposTarefa2. *)
...
(*Exercíio 1 aula 13/07: Prove que natural * 0 é 0. *)
...
(*Lista 3, questão 1 - disponível no arquivo: Lista3-Q1-plus_comm.v*)
...
(*Lista 3 - questão 2 - associatividade da soma - disp. no arq: Lista3-Q2-plus_assoc.v*)
...
(*Importei negb, evenb_S e negb_involutive para fazer o exercício 3*)
...
(*Teorema auxiliar para o ex3*)
Lemma evenb_SS: forall n : nat, evenb (S (S n)) = evenb n.
  Proof.
  intro n. simpl. reflexivity. Qed.

(*Exercício 3 da aula 13/07:*)
Theorem evenb_S : forall n : nat,
  evenb (S n) = negb (evenb n).
  Proof.
  intro n. induction n as [ | n' IH].
  - simpl. reflexivity. (*poderia usar reflexivity direto*)
  - rewrite evenb_SS. rewrite IH. (*fica com neg neg*) rewrite negb_involutive.
    reflexivity. Qed.
(** [] *)
...
(*bastante frequente precisar de uma lemma auxiliar para provar algo*)
Lemma mult_s : forall m n : nat, n * (S m) = n + n * m.
Proof.
...
Theorem mult_comm : forall m n : nat,
  m * n = n * m.
Proof.
  intros n m. induction m as [ | n' IH]. (*IH hipótese de indução, IH como hipotese indução*)
  + simpl. rewrite mult_0_r. reflexivity.
  + simpl. rewrite mult_s. rewrite IH. reflexivity.
(** [] *)
...
(*Lista 3 - questão 5 - que n é menor ou igual a n.*)
...
(*Lista 3 - questão 6 - para qlqr bool e falso, retorna falso.*)
Theorem andb_false_r : forall b : bool,
  andb b false = false.
Proof.
  intros b. destruct b. (*desconstruo para abrir todas as possiblidade de combinação de bool*)
  - reflexivity.
  - reflexivity.
Qed.
